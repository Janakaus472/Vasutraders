    ...
    <>
      ...
      <button
        ...
        onMouseLeave={e => {
          ...
          ;(e.currentTarget as HTMLButtonElement).style.boxShadow = '0 4px 20px rgba(249,115,22,0.4)'
        }}
      >
        {open ? (
        ...
        >
          ...
          <div style={{
            ...
            <div>
              ...
              <div style={{ color: 'rgba(255,255,255,0.85)', fontSize: '11px' }}>Usually replies in seconds</div>
            </div>
            <a
            ...
            {messages.map((msg, i) => (
              ...
              >
                <div style={{
                  ...
                  border: msg.role === 'assistant' ? '1px solid #f3e8d8' : 'none',
                  whiteSpace: 'pre-wrap',
                }}>
          ...
          <div style={{
            ...
            <input
              ...
              onBlur={e => (e.currentTarget.style.borderColor = '#f3e8d8')}
            />
            <button
              onClick={sendMessage}
