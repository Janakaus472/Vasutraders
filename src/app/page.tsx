    ...
    <div className="bg-[#FFFBF5]" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      <section className="relative overflow-hidden grain-overlay" style={{
            ...
            <div className="hidden lg:block relative" style={{ height: '480px' }}>
              {[
                ...
                <div key={card.name} className={card.cls} style={{
                  ...
                  <div style={{ color:'#fff', fontFamily:"'Plus Jakarta Sans', sans-serif", fontWeight:700, fontSize:'13px', whiteSpace:'nowrap' }}>{card.name}</div>
        ...
        <svg style={{ position:'absolute', bottom:0, left:0, right:0, display:'block' }} viewBox="0 0 1440 60" preserveAspectRatio="none" height="60">
          <path d="M0,60 L0,30 Q360,0 720,30 Q1080,60 1440,20 L1440,60 Z" fill="#FFFBF5" />
        </svg>
      </section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {STATS.map((s) => (
              <div key={s.label} className="text-center">
                ...
                <div style={{ color:'#6B7280', fontFamily:"'Plus Jakarta Sans', sans-serif", fontWeight:600, fontSize:'14px', marginTop:'4px' }}>{s.label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <h2 className="display-font" style={{ fontSize:'clamp(40px, 5vw, 64px)', color:'#0f2744', lineHeight:1.05 }}>
            BROWSE BY CATEGORY
          </h2>
        </div>
      ...
      <section style={{ background:'#FF6B00', padding:'72px 24px', textAlign:'center', position:'relative', overflow:'hidden' }}>
        ...
        <div className="relative z-10">
          ...
          <p style={{ color:'rgba(255,255,255,0.85)', fontFamily:"'Plus Jakarta Sans', sans-serif", fontSize:'18px', marginBottom:'36px', fontWeight:500 }}>
            Browse our catalog or reach us directly on WhatsApp
          </p>
