      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ fontSize: '18px', color: '#5C2D0F', fontWeight: 700, lineHeight: 1.6 }}>
            Send your order to Vasu Traders on WhatsApp<br />
            to confirm it instantly!
          </p>
        </div>
        ...
        <a href={waUrl} target="_blank" rel="noopener noreferrer" onClick={() => {
          ...
          fontWeight: 800, padding: '18px 32px', borderRadius: '16px',
          fontSize: '20px', textDecoration: 'none', width: '100%',
          boxShadow: '0 8px 32px rgba(37,211,102,0.4)', marginBottom: '16px',
        }}>
